...
If a list containing less than 9 elements is passed into the function, it will raise a ValueError exception with the message: "List must contain nine numbers." The values in the returned dictionary will be lists and not Numpy arrays.
...
The unit tests for this project are in test_module.py. The tests have been imported from test_module.py to main.py by fcc for convenience.
